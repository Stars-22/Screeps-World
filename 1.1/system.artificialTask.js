...
var systemArtificialTask = {
    ...
    */
    run: function() {
        ...
        outStore1.push(Game.getObjectById('6552ff27b241a6326feffbea'));
        outStore1.push(Game.getObjectById('6553e7654f26da05aea93b8d'));
        taskHomeScheduling.run(5, 2, inStore1, outStore1);
	}
};
