...
var queueTaskTemporary = {
    ...
    */
    run: function() {
        ...
        var path1 = ['W33N48','W32N48','W32N47','W32N46','W31N46','W31N45','W32N45','W31N43','W30N43','W30N44','W30N45','W31N45'];
        var path2 = ['W33N48','W32N48','W32N47','W32N46','W31N46','W30N46','W30N45','W30N44','W30N43','W31N43','W32N43','W32N44','W32N45'];
        var path3 = [
        ...
        //#0-4 防御2
        if(taskAttackInvader.run('0-4', 1, nameRoomClainmer, waitPos1, moduleAttacker1, spawnName.W34N48[0], path1) != 0)
            reportWrongExit.run('#0-4 防御2');

        //#0-5 防御3
        if(taskAttackInvader.run('0-5', 2, nameRoomClainmer, waitPos1, moduleAttacker1, spawnName.W33N49[0], path1) != 0)
            reportWrongExit.run('#0-5 防御3');

        //#0-6 新基地建设1
        if(taskNewRoomBuild.run('0-6', 2, nameRoomClainmer, moduleNewRoomBuilder, 0, spawnName.W33N49[0], path1) != 0)
            reportWrongExit.run('#0-6 新基地建设1');

        //#0-7 新基地建设2
        if(taskNewRoomBuild.run('0-7', 1, nameRoomClainmer, moduleNewRoomBuilder, 1, spawnName.W34N48[0], path1) != 0)
